...
const FeatureCard: React.FC<FeatureCardProps> = ({
  ...
  return (
    <div
      ref={cardRef}
      className={`group relative bg-white/80 backdrop-blur-sm rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-2 border border-stone-200/50 ${className}`}
    >
